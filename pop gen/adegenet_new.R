...
hist(dp, xlim = c(0,120), ylim = c(0,8000), breaks = 100)
?hist
...
par(mar = c(12,4,4,2))
barplot(myMiss, las = 2, col = 1:12, ylim = c(0,1))
...
barplot(pcoa1$eig[1:10],main="PCA eigenvalues", col=heat.colors(50), ylim = c(0,2000)) #Good!
